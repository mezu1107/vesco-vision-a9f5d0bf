...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-cROYZywJ.mjs");
...
var manifest = {
	"7ecdb867ca02f555264b731157faf2f1f6d851bd4728472f40587d1821cb18a3": {
		functionName: "updatePageData_createServerFn_handler",
		importer: () => import("./page-api-2YOiEd0c.mjs")
	},
	"8e5011b922d8600e4c8a562c36f1e819ba33c08dc61ba8a95c8ac9c2be0ff080": {
		functionName: "getPageData_createServerFn_handler",
		importer: () => import("./page-api-2YOiEd0c.mjs")
	},
	"b5b98925bce8557944fad164959dbcc40f431f900cd131f76e1be94b062dae01": {
		functionName: "listAllPages_createServerFn_handler",
		importer: () => import("./page-api-2YOiEd0c.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CozBOSu6.mjs").then((n) => n.t),
		import("./start-DiFI3OJ0.mjs"),
