//#region node_modules/.nitro/vite/services/ssr/assets/page-defaults-CKP3PSIM.js
/**
* Default content for every page that can be edited via the admin panel.
* Pages that use i18n have their content stored here as plain objects
* (mirroring the en.ts locale keys) so the admin can edit and save them.
*/
var PAGE_DEFAULTS = {
	home: null,
	about: null,
	facility: {
		...
		cleanroomSection: {
			...
			image: "/assets/korean-cleanroom-facility.jpg"
		},
		coldChainSection: {
			...
			image: "/assets/korean-international-logistics.jpg"
		}
	},
	quality: {
		hero: {
	...
	research: {
		hero: {
			...
			image: "/assets/research-team.jpg"
		},
		areas: {
			eyebrow: "R&D",
		...
		seoulSection: {
			...
			image: "/assets/seoul-biotech-campus.jpg"
		},
		scientistsSection: {
			...
			image: "/assets/korean-bio-researchers.jpg"
		}
	},
	contact: {
		hero: {
		...
		officeSection: {
			...
			image: "/assets/korean-contact-office.jpg"
		},
		consultSection: {
			eyebrow: "Direct Scientific Advisory",
			title: "Personalized Technical Consultation",
			image: "/assets/korean-doctor-consultant.jpg"
		}
	},
	faq: {
		hero: {
				...
				items: [
					{
						...
						a: "Storage condition is defined per format and stated on the product documentation."
					},
					{
	...
	insights: {
		...
		articles: [
			{
				slug: "why-characterization-defines-quality",
			...
			{
				slug: "lyophilization-stability-strategy",
			...
			{
				slug: "product-documentation-multiple-markets",
				category: "Regulatory",
			...
			{
				slug: "questions-for-contract-manufacturer",
	...
	"about-mission": {
		...
		seoulSection: {
			...
			image: "/assets/korean-seoul-skyscraper-hub.jpg"
		}
	},
	"about-network": {
		hero: {
		...
		supportSection: {
			...
			image: "/assets/korean-faq-support-center.jpg"
		},
		coverage: {
			...
			fields: [
				{
					...
					ph: "e.g. Exosome, PDRN, Peptide"
				},
				{
					label: "Target Application",
					ph: "e.g. Skin, Scalp, Aesthetic"
				},
				{
					label: "Active Ingredient",
					ph: "e.g. Exosome 1×10¹¹/mL"
				},
				{
				...
				{
					label: "Dosage Form",
					ph: "e.g. Lyophilized, Solution, Gel"
				},
				{
					label: "Packaging Format",
					ph: "e.g. 2mL vial, ampoule, kit"
				},
				{
					label: "MOQ",
					ph: "e.g. 500 units"
