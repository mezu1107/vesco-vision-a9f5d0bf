...
//#region node_modules/.nitro/vite/services/ssr/assets/about.network-DODuX1OM.js
var import_jsx_runtime = require_jsx_runtime();
var headquarters_default = "/assets/headquarters-CII9tuSE.jpg";
var korean_international_logistics_default = "/assets/korean-international-logistics-SFQjIwEG.jpg";
var korean_faq_support_center_default = "/assets/korean-faq-support-center-0RdQk7qI.jpg";
var COPY = {
	en: {
		...
		regions: [
			{
				name: "Asia-Pacific",
				status: "Active cGMP Export Operations"
			},
			{
				name: "Middle East & GCC",
				status: "Regulatory Compliance Support"
			},
			{
				name: "Europe",
				status: "CPNP Dossier Alignment"
			},
			{
				name: "Latin America",
				status: "Custom Packaging Support"
			},
			{
				name: "North America",
				status: "OEM / ODM Distribution Channels"
			},
			{
				name: "CIS Region",
				status: "Cold-Chain Logistics Ready"
			}
		]
	},
	ko: {
		...
		models: [
			{
				title: "유통 파트너십",
				body: "국가·지역 단위 유통과 MFDS 기준 규제 문서를 함께 제공합니다."
			},
			{
				title: "프라이빗 라벨",
				body: "검증된 한국 바이오 제형을 파트너의 전용 브랜드·패키지로 생산합니다."
			},
			{
				title: "OEM 제조",
				body: "고객사 처방을 서울 cGMP 시설에서 엄격하게 제조·충전·출하 문서화합니다."
			},
			{
				title: "ODM 개발",
				body: "컨셉 수립부터 제형 연구·동결건조·안정성 검증까지 베스코가 종합 제공합니다."
			},
			{
				title: "R&D 공동 연구",
				body: "엑소좀, PDRN/PN, 펩타이드 플랫폼의 특성 분석 및 글로벌 공동 연구."
			},
			{
				title: "클리닉 직공급",
				body: "해외 목적 시장의 의료기기·화장품 규정에 맞춘 정품 공급 프로그램."
			}
		],
		...
		regions: [
			...
			{
				name: "유럽",
				status: "CPNP 기술 문서 대응"
			},
			{
				name: "중남미",
				status: "맞춤형 포장 및 라벨 지원"
			},
			{
				name: "북미",
				status: "OEM / ODM 유통망 협력"
			},
			{
				name: "CIS 지역",
				status: "콜드체인 물류 파이프라인"
			}
		]
	}
};
function Page() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "mt-4 text-[1.08rem] font-semibold text-navy",
							children: m.title
						}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "eyebrow",
							children: "Export Air Freight"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-[0.9rem] text-navy",
							children: "Incheon International Cold Chain Hub"
						})]
					})]
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Shipping temperature-sensitive biologics around the globe requires rigorous quality management. Every export batch leaving our Seoul facility is packed in validated thermal insulated shippers equipped with real-time temperature loggers."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 text-[1rem] leading-relaxed text-muted-foreground",
							children: "With direct access to major international airlines at Incheon International Airport, we ensure rapid dispatch and customs clearance for our distribution partners across North America, Europe, Asia, and the Middle East."
						})
					] })
				})]
			})
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-6 text-[1rem] leading-relaxed text-muted-foreground",
							children: "Our global business team in Seoul works closely with international brand owners and clinical distributors to navigate product regulatory filings, market-specific packaging customization, and batch scheduling."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 text-[1rem] leading-relaxed text-muted-foreground",
							children: "Whether you need technical clarification on exosome concentrations or custom labeling compliance for your local market, our dedicated Korean team provides bilingual support throughout the partnership lifecycle."
						})
					] })
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "eyebrow",
							children: "Seoul Corporate Headquarters"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-[0.9rem] text-navy",
							children: "Global Partnership Consultation Desk"
						})]
					})]
				}) })]
			})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
			tone: "white",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, { title: c.coverageTitle }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: c.regions.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "mt-1 text-[0.78rem] tracking-[0.08em] uppercase text-teal font-semibold",
						children: r.status
					})]
				}, r.name))
			})]
