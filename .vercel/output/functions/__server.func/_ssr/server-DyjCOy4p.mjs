...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CN73rSf3.mjs");
...
var manifest = {
	"7ecdb867ca02f555264b731157faf2f1f6d851bd4728472f40587d1821cb18a3": {
		...
		importer: () => import("./page-api-B9NLcm5S.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-RzC8V2F6.mjs").then((n) => n.t),
		import("./start-eiMqY3pn.mjs"),
