...
export const PAGE_DEFAULTS: Record<string, any> = {
  // ── CMS-backed pages (Supabase JSON) ─────────────────────────────────
  home: null, // loaded from fallback.ts separately
  about: null, // loaded from fallback.ts separately

  // ── i18n-backed pages (en.ts keys mirrored here) ─────────────────────
  ...
  insights: {
    ...
    articles: [
      { slug: "why-characterization-defines-quality", category: "Exosome Science", title: "Why characterization defines exosome product quality", excerpt: "Particle count alone does not describe a preparation. A short look at the parameters that together define a specification." },
      { slug: "lyophilization-stability-strategy", category: "Manufacturing", title: "Lyophilization as a stability strategy for biologic formats", excerpt: "Cycle design, excipient selection and reconstitution behaviour — and why they are decided before scale-up, not after." },
      { slug: "polynucleotide-platforms", category: "PDRN / PN", title: "Polynucleotide platforms in regenerative formulation", excerpt: "How PDRN and PN materials are handled in formulation and what that means for finished-product design." },
      { slug: "korea-regenerative-hub", category: "Korean Biotechnology", title: "Why Korea became a regenerative manufacturing hub", excerpt: "Research density, manufacturing discipline and export orientation — the structural reasons behind Korea's position." },
      { slug: "product-documentation-multiple-markets", category: "Regulatory", title: "Preparing product documentation for multiple markets", excerpt: "A practical view of how documentation requirements shape development decisions from the first meeting." },
      { slug: "questions-for-contract-manufacturer", category: "Industry Insights", title: "What partners should ask a contract manufacturer", excerpt: "Ten questions that reveal whether a manufacturing partner can actually support a long-term product line." },
    ],
  },
