 ...
 * All image paths use root-relative /filename.jpg (served from public/).
 * Do NOT use import statements for images here — this file is loaded inside
 * createServerFn handlers in the Vercel/Nitro Node.js runtime where Vite
 * asset bundling is not available.
 */

export const PAGE_DEFAULTS: Record<string, any> = {
  // home and about load from src/data/fallback.ts separately
  home: null,
  about: null,
  ...
  facility: {
    ...
    cleanroomSection: {
      ...
      image: "/korean-cleanroom-facility.jpg",
    },
    coldChainSection: {
      ...
      image: "/korean-international-logistics.jpg",
    },
  },
  ...
  research: {
    ...
    seoulSection: {
      ...
      image: "/seoul-biotech-campus.jpg",
    },
    scientistsSection: {
      ...
      image: "/korean-bio-researchers.jpg",
    },
  },
  ...
  "about-mission": {
    ...
    seoulSection: {
      ...
      image: "/korean-seoul-skyscraper-hub.jpg",
    },
  },
  ...
  "about-network": {
    ...
    supportSection: {
      ...
      image: "/korean-faq-support-center.jpg",
    },
    coverage: {
